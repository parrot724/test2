...
from mic_test import test_acc, show_label
...
def single_recog(file_name):
    ...
    for i in range(speech_num):
        ...
        #speech_path = test_path + str(i) + '.' + audiotype
        speech_path = test_path + str(file_name) + '.wav'
        ...
        pinyin_l, word_l = show_label(int(file_name))
        print '-'*25 + str(file_name) + '.wav Result' + '-'*25
        print '拼音： ' + str(pinyin)
        print '文本： ' + str(txt)
        print '-'*25 + str(file_name) + '.wav Label' + '-'*25
        print '拼音： ' + str(pinyin_l)
        print '文本： ' + str(word_l)
...
def all_recog():
    ...
    # 清空文件内容
    open('results/asr_results.txt', 'w').close()

    for i in range(speech_num):
        #speech_path = wav_seg_path + str(i) + '.' + audiotype

        #speech_path = test_path + str(i) + '.' + audiotype
        speech_path = test_path + str(i) + '.wav'
        ...
        pinyin_l, word_l = show_label(i)

        print '-'*25 + str(i) + '.wav Result' + '-'*25
        print '拼音： ' + str(pinyin)
        print '文本： ' + str(txt)
        print '-'*25 + str(i) + '.wav Label' + '-'*25
        print '拼音： ' + str(pinyin_l)
        print '文本： ' + str(word_l)
        print '\n'*2
        #print 'finished ' + str(i)
