...
emotion1_path = 'emotion/negative1.txt' # 学生1消极情绪节点文件
emotion2_path = 'emotion/negative2.txt' # 学生2消极情绪节点文件
...
for i in range(len(knowledge_list)):
    ...
    # 记录每个知识点所对应的语音序号
    f = open('results/results.txt','a+b')
...
# 将消极情绪节点与知识点匹配
# 读取学生1,2的消极情绪结果
num1,negative_list1 = read_file('emotion/negative1.txt')
num2,negative_list2 = read_file('emotion/negative2.txt')
